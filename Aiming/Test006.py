...
class FaceTracker:
    ...
    def process_frame(self, frame):
        ...
        frame = cv2.flip(frame, 1)  # Flip horizontally for mirror effect in portrait mode
        ...
        if results.multi_face_landmarks:
            ...
            if self.calibration_frames < self.CALIBRATION_DURATION:
                ...
                # Draw movement vector if calibration center is set
...
def main():
    ...
    cap = cv2.VideoCapture("http://192.168.137.168:8080/video")
